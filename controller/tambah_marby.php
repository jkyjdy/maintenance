...
mysqli_query($koneksi, "insert into laporan (ID,nama,tgl,ruangan,genset,kompor,mesin_penggiling_merica,oven,pemanas_air,perbaikan,lain) values ('','$nama','$tgl','$ruangan','$genset','$kompor','$mesin_penggiling_merica','$oven','$pemanas_air','$perbaikan','$lain')");
    ...
    echo"<script>
      swal({ title: 'Berhasil',
         ...
         type: 'success'}).then(okay => {
           if (okay) {
            window.location.href = '../laporan_marby.php';
          }
        });
      </script>";
