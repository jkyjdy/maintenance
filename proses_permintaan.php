			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Proses Permintaan</h4>
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											while($isi =mysqli_fetch_array($data)) {
												...
												<tr>
													...
													<td><a data-target="#modal_before <?php echo $isi['ID'];?>" data-toggle="modal"><img src = 'images/<?php echo $isi['foto_before'];?>'  width = "100%" height = "50"></a>
													<!-- =============================================================================================== -->
