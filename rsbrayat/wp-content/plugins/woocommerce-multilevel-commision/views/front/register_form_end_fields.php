...
?>
        ...
        <p class="referral_code_panel form-row form-row-wide">
            ...
            <input type="text" <?php echo $readonly;?> placeholder="<?php echo $wmc_required_referral_field == 'yes' ? __('Enter referral code', 'wmc') : __( 'Add referral code if you have', 'wmc' );?>"  class="input-text" <?php $wmc_required_referral_field == 'yes' ? 'required' : ''; ?> name="referral_code" id="referral_code" value="<?php echo isset($data['referral_code'])?$data['referral_code']:''; ?>" />           
