...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		array(
			'name'     => esc_html__( 'Contact Form by WPForms', 'salute' ),
			'slug'     => 'wpforms-lite',
			'required' => false,
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'salute' ),
			'slug'     => 'woocommerce',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'salute' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html__( 'Vamtam Elementor Integration', 'salute' ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'salute' ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'salute' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'salute' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'salute' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'salute' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'WP Super Cache', 'salute' ),
			'slug'     => 'wp-super-cache',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'salute' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'salute' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Self-hosted Google Fonts', 'salute' ),
		...
		array(
			'name'     => esc_html__( 'Cookie Notice for GDPR & CCPA', 'salute' ),
			'slug'     => 'cookie-notice',
			'required' => false,
			'category' => 'recommended',
		),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'salute' ),
		'description' => esc_html__( 'Description', 'salute' ),
		'status'      => esc_html__( 'Status', 'salute' ),
		'version'     => esc_html__( 'Version', 'salute' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'salute' );
	}
	if ( strpos( $plugin['slug'], 'salute' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'salute' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'salute' );
