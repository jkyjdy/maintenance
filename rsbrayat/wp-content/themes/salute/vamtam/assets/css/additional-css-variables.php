...
$border_accent_num = vamtam_extra_features() ? 7 : 4;
$line_color = implode( ',', ( new VamtamColor( vamtam_get_option( 'accent-color', $border_accent_num ) ) )->getRgb() );
...
return array(
	...
	'default-line-color' => ( ! is_customize_preview() && ! vamtam_use_accent_preview() ) ? "rgba( {$line_color}, 1 )" : 'rgba( var( --vamtam-accent-color-' . $border_accent_num . '-rgb ), 1 )',
