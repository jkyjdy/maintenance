	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'salute' ),
				'iconName'   => esc_html__( 'Icon', 'salute' ),
				'iconText'   => esc_html__( 'Text', 'salute' ),
				'iconLink'   => esc_html__( 'Link', 'salute' ),
				'iconChange' => esc_html__( 'Change', 'salute' ),
