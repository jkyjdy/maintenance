...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		function vamtam_elementor_widgets_support( bool $supports, array $args, string $feature ) {
			...
			$supported_features = [
				...
				'nav-menu--dropdown-min-width',
				'nav-menu--dropdown-left-distance',
				'slides--force-slide-stretch',
				'search-form--disable-scroll',
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'salute' ),
				)
			);
		}
	}
	...
	private function load_languages() {
		load_theme_textdomain( 'salute', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'salute' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'salute' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'salute' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'salute' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'salute' );
		echo '</span>';
	}

	public static function license_unregister() {
		esc_html_e( 'Unregistered Key.', 'salute' );
	}
}
