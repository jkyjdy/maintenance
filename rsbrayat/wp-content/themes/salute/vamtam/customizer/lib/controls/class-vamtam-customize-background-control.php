...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'salute' ),
			'change'       => esc_html__( 'Change Image', 'salute' ),
			'remove'       => esc_html__( 'Remove', 'salute' ),
			'default'      => esc_html__( 'Default', 'salute' ),
			'placeholder'  => esc_html__( 'No image selected', 'salute' ),
			'frame_title'  => esc_html__( 'Select Image', 'salute' ),
			'frame_button' => esc_html__( 'Choose Image', 'salute' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'salute' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'salute' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'salute' ),
				'repeat'    => esc_html__( 'Repeat both', 'salute' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'salute' ),
				'fixed'  => esc_html__( 'fixed', 'salute' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'salute' ),
				'cover'   => esc_html__( 'cover', 'salute' ),
				'contain' => esc_html__( 'contain', 'salute' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'salute' ),
				'left center'   => esc_html__( 'left center', 'salute' ),
				'left bottom'   => esc_html__( 'left bottom', 'salute' ),
				'center top'    => esc_html__( 'center top', 'salute' ),
				'center center' => esc_html__( 'center center', 'salute' ),
				'center bottom' => esc_html__( 'center bottom', 'salute' ),
				'right top'     => esc_html__( 'right top', 'salute' ),
				'right center'  => esc_html__( 'right center', 'salute' ),
				'right bottom'  => esc_html__( 'right bottom', 'salute' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'salute' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'salute' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'salute' ),
			'background-repeat'     => esc_html__( 'Repeat', 'salute' ),
			'background-image'      => esc_html__( 'Image', 'salute' ),
			'background-attachment' => esc_html__( 'Attachment', 'salute' ),
			'background-size'       => esc_html__( 'Size', 'salute' ),
			'background-position'   => esc_html__( 'Position', 'salute' ),
			'background-color'      => esc_html__( 'Color', 'salute' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'salute' ),
				'color-2'              => esc_html__( 'Color 2', 'salute' ),
				'location'             => esc_html__( 'Location', 'salute' ),
				'type'                 => esc_html__( 'Type', 'salute' ),
				'position'             => esc_html__( 'Position', 'salute' ),
				'angle'                => esc_html__( 'Angle', 'salute' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'salute' ),
					'radial' => esc_html__( 'Radial', 'salute' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'salute' ),
					'center left'   =>  esc_html__( 'Center Left' , 'salute' ),
					'center right'  =>  esc_html__( 'Center Right' , 'salute' ),
					'top center'    =>  esc_html__( 'Top Center' , 'salute' ),
					'top left'      =>  esc_html__( 'Top Left' , 'salute' ),
					'top right'     =>  esc_html__( 'Top Right' , 'salute' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'salute' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'salute' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'salute' ),
				],
			],
		);
