...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'salute' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'salute' ),
			'font-weight'                     => esc_html__( 'Weight', 'salute' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'salute' ),
				'uppercase'    => esc_html__( 'Uppercase', 'salute' ),
				'lowercase'    => esc_html__( 'Lowercase', 'salute' ),
				'capitalize'   => esc_html__( 'Capitalize', 'salute' ),
				'normal'       => esc_html__( 'Normal', 'salute' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'salute' ),
				'normal'       => esc_html__( 'Normal', 'salute' ),
				'italic'       => esc_html__( 'Italic', 'salute' ),
				'oblique'      => esc_html__( 'Oblique', 'salute' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'salute' ),
				'underline'    => esc_html__( 'Underline', 'salute' ),
				'overline'     => esc_html__( 'Overline', 'salute' ),
				'line-through' => esc_html__( 'Line Through', 'salute' ),
				'none'         => esc_html__( 'None', 'salute' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'salute' ),
			'line-height'                => esc_html__( 'Line Height', 'salute' ),
			'color'                      => esc_html__( 'Font Color', 'salute' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'salute' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'salute' ), [ 'code' => [] ] ),
		);
	}
	/**
